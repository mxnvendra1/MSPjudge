...
st.markdown(
    ...
    .block-container {{padding-top: 2.6rem; padding-bottom: 4rem; max-width: 760px;}}
    .stApp {{background: #fbfaf9;}}
    .stApp :is(h1, h2, h3, p, label, input, textarea, button,
               div:not([data-testid="stIconMaterial"])) {{
        font-family: 'Inter', -apple-system, 'Segoe UI', sans-serif;
    }}
    h1, h2, h3, p, span, div {{color: {INK};}}
    .lj-muted {{color: {MUTED}; font-size: 12.5px;}}
    .lj-section {{margin: 30px 0 4px; font-size: 11px; letter-spacing: .1em;
                  text-transform: uppercase; color: {MUTED}; font-weight: 600;}}
    .lj-card {{padding: 13px 0; border-bottom: 1px solid #eceae7;}}
