"""
LineJudge — every price, in or out.
...
BRANDS = {
    "Hundred": "assets/hundred.png",
    "Li-Ning": "assets/lining.png",
}
...
with c1:
    st.markdown(
        ...
        f"LineJudge <span style='font-weight:400;color:{MUTED};font-size:14px'>"
